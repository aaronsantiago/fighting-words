...
class DefaultInputReader {
    constructor(canvas, pointerLock, touchControls) {
        this.PRESSED_KEYS = {};
...
/* harmony import */ var chai__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! chai */ "./node_modules/chai/index.mjs");
...
class GameWrapper {
    constructor(gameClass) {
        ...
        this.inputReader = new _defaultinput__WEBPACK_IMPORTED_MODULE_0__.DefaultInputReader(this.canvas, this.gameClass.pointerLock || false, this.gameClass.touchControls || {});
    }
    ...
    checkChannel(channel) {
        chai__WEBPACK_IMPORTED_MODULE_6__.assert.isTrue(this.isChannelOrdered(channel), "Data Channel must be ordered.");
        chai__WEBPACK_IMPORTED_MODULE_6__.assert.isTrue(this.isChannelReliable(channel), "Channel must be reliable.");
    }
    /**
    ...
    start() {
        loglevel__WEBPACK_IMPORTED_MODULE_2__.info("Creating a PeerJS instance.");
        this.menu.innerHTML = "Connecting to PeerJS...";
        this.peer = new (peerjs__WEBPACK_IMPORTED_MODULE_3___default())();
        this.peer.on("error", (err) => console.error(err));
        this.peer.on("open", (id) => {
            // Try to parse the room from the hash. If we find one,
            // we are a client.
            const parsedHash = query_string__WEBPACK_IMPORTED_MODULE_4__.parse(window.location.hash);
            const isClient = !!parsedHash.room;
            if (isClient) {
                // We are a client, so connect to the room from the hash.
                this.menu.style.display = "none";
                loglevel__WEBPACK_IMPORTED_MODULE_2__.info(`Connecting to room ${parsedHash.room}.`);
                const conn = this.peer.connect(parsedHash.room, {
                    serialization: "json",
                    reliable: true,
                    // @ts-ignore
                    _payload: {
                ...
                loglevel__WEBPACK_IMPORTED_MODULE_2__.info("Showing join link.");
                // Show the join link.
                ...
                qrcode__WEBPACK_IMPORTED_MODULE_5__.toCanvas(qrCanvas, joinURL);
                // Construct the players array.
                const players = [
...
/* harmony import */ var _gamewrapper__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./gamewrapper */ "./src/gamewrapper.ts");
...
class LockstepWrapper extends _gamewrapper__WEBPACK_IMPORTED_MODULE_4__.GameWrapper {
    ...
    startHost(players, conn) {
        ...
        this.lockstepNetcode = new _netcode_lockstep__WEBPACK_IMPORTED_MODULE_2__.LockstepNetcode(true, this.game, players, this.gameClass.timestep, this.stateSyncPeriod, () => this.inputReader.getInput(), (frame, input) => {
    ...
    startClient(players, conn) {
        ...
        this.game = new this.gameClass(this.canvas, players);
        this.lockstepNetcode = new _netcode_lockstep__WEBPACK_IMPORTED_MODULE_2__.LockstepNetcode(false, this.game, players, this.gameClass.timestep, this.stateSyncPeriod, () => this.inputReader.getInput(), (frame, input) => {
            conn.send({ type: "input", frame: frame, input: input.serialize() });
        });
        conn.on("data", (data) => {
            if (data.type === "input") {
...
/* harmony import */ var loglevel__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! loglevel */ "./node_modules/loglevel/lib/loglevel.js");
/* harmony import */ var loglevel__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(loglevel__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _gamewrapper__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./gamewrapper */ "./src/gamewrapper.ts");
...
/* harmony export */ });
/* harmony import */ var _autoserialize__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./autoserialize */ "./src/autoserialize.ts");
...
class NetplayState {
     ...
     */
    serialize() {
        return _autoserialize__WEBPACK_IMPORTED_MODULE_0__.serialize(this);
    }
    /**
     * By default, use the auto deserializer.
     */
    deserialize(value) {
        _autoserialize__WEBPACK_IMPORTED_MODULE_0__.deserialize(value, this);
    }
}
class NetplayInput {
    /**
...
/* harmony export */   "GameWrapper": () => (/* reexport safe */ _gamewrapper__WEBPACK_IMPORTED_MODULE_2__.GameWrapper),
/* harmony export */   "LockstepWrapper": () => (/* reexport safe */ _lockstepwrapper__WEBPACK_IMPORTED_MODULE_3__.LockstepWrapper),
/* harmony export */   "RollbackWrapper": () => (/* reexport safe */ _rollbackwrapper__WEBPACK_IMPORTED_MODULE_4__.RollbackWrapper),
...
/* harmony import */ var _gamewrapper__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./gamewrapper */ "./src/gamewrapper.ts");
/* harmony import */ var _lockstepwrapper__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./lockstepwrapper */ "./src/lockstepwrapper.ts");
/* harmony import */ var _rollbackwrapper__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./rollbackwrapper */ "./src/rollbackwrapper.ts");
...
/* harmony import */ var _json__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./json */ "./src/json.ts");
